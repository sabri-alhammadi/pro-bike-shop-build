...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'pro-bike-shop-build-7rp8a.myshopify.com';
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: الدفع مطلوب", {
      description: "يتطلب الوصول إلى Shopify API خطة فوترة نشطة.",
    });
    return;
  }
